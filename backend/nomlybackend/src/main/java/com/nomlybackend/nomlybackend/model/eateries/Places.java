...
//    private String apiKey;
    ...
    public static List<Eateries> findEateries(LocationDTO locationDTO) throws Exception{
        ...
        HttpRequest postRequest = HttpRequest.newBuilder()
                ...
                .header("X-Goog-FieldMask", "places.plusCode.globalCode,places.displayName.text,places,places.priceLevel,places.types,places.rating") //,places.photos.googleMapsUri
        ...
        for (PlacesDTO.Place place: places.getPlaces()){
